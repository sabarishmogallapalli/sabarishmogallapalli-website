...
import { sideLinkInformation } from "../content/site/links"
    ...
    return (<div className="bg-white flex flex-col h-screen justify-between antialiased">
            ...
            <div className="min-h-screen w-screen overflow-x-auto hidden lg:flex paragraph-color-bg">
                ...
                <div className="w-[40%] absolute" >
                    <StaticImage src={'../../static/logo_black_transp.png'} className="!w-[45%] !m-7 !ml-7 !mt-16 !rounded-3xl !flex !justify-center !items-center !z-50" alt="Profile Picture" />
                    <div className="w-full text-5xl p-6 pt-0 flex primary-text overflow-visible whitespace-nowrap">{NAME}</div>
...
/* export default function SideBarLayout(props) {
    return (<div className="bg-white flex flex-col h-screen justify-between antialiased">
            ...
            <div className="min-h-screen w-screen overflow-x-auto hidden lg:flex paragraph-color-bg">
                {/* Left bar}/*
                <div className="w-[40%] absolute" >
                    <StaticImage src={'../../static/headshot.png'} className="!w-[45%] !m-7 !ml-7 !mt-16 !rounded-3xl !flex !justify-center !items-center !z-50" alt="Profile Picture" />
                    <div className="w-full text-5xl p-6 pt-0 flex primary-text overflow-visible whitespace-nowrap">{NAME}</div>
                    <div className="w-full text-xl pl-7 flex font-bold paragraph-color-text">{JOB_TITLE}</div>
                    <p className="w-[90%] text-lg pl-7 pt-1 paragraph-text">{DESC}</p>
