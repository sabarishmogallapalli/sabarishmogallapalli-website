...
import { cliveCommunityFoundationInformation } from "../content/data/CliveCommunityFoundation";
import { CLIVE_COMMUNITY_PROJECT } from "../content/site/links";
...
<div>
    ...
    <h1 style={{textAlign: "left", color: "#2c3639", fontSize: "7xl", md: { fontSize: "4xl" }, fontWeight: "bold"}}>Clive Community Foundation</h1>
...
<li style={{paddingBottom:"100px", listStyle: 'none'}}>UX Lead</li>
    ...
    <div>
    <img src="../ccf.png" alt="ccf laptop" style={{width:"1000px", marginLeft:"1px", marginRight:"0px", marginTop:"0px"}}></img>
    </div>
    </div>
